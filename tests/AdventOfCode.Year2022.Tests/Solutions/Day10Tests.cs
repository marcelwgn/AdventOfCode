...
namespace AdventOfCode.Year2022.Tests.Solutions
{
    ...
    public class Day10Tests
    {
        ...
        {
            Assert.AreEqual(-41440, Day10.FirstProblem(DATA_SMALL));
            Assert.AreEqual(13140, Day10.FirstProblem(DATA_LARGE));
        }
        ...
        public void VerifySecondProblem()
        {
            var result = "##..##..##..##..##..##..##..##..##..##.." + Environment.NewLine + 
                ...
                "######......######......######......####" + Environment.NewLine + 
                "#######.......#######.......#######....." + Environment.NewLine;
            Assert.AreEqual(result, Day10.SecondProblem(DATA_LARGE));
        }
    }
}
